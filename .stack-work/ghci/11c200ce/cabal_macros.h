...
/* package sim-city-0.1.0.0 */
#ifndef VERSION_sim_city
#define VERSION_sim_city "0.1.0.0"
#endif /* VERSION_sim_city */
#ifndef MIN_VERSION_sim_city
#define MIN_VERSION_sim_city(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sim_city */
...
#define CURRENT_PACKAGE_KEY "sim-city-0.1.0.0-7qRivmsmxYX16VkvqYFQya"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "sim-city-0.1.0.0-7qRivmsmxYX16VkvqYFQya"
