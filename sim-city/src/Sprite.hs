...
-- dans le module Sprite : abstraction pour les lutins de jeu vidéos, chaque lutin pouvant être associé à plusieurs
-- images (elles-même faisant référence à un nom de texture).
